...
export default function VerifyContractPage() {
  const [result, setResult] =
    useState<VerifySmartContractDeploymentOutput | null>(null);
    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">
          Develop & Deploy Contract
        </h1>
        <p className="text-muted-foreground">
          Use our AI assistant to develop, audit, and deploy your smart
          contracts.
        </p>
      </div>
            ...
            {result && (
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <p className="whitespace-pre-wrap rounded-md bg-muted p-4 font-mono text-sm text-muted-foreground">
